...
// export default is the definition of what is imported by default when someone runs the app
                          // extends React.Component converts everything inside to a React object
export default class App extends React.Component {
  ...
  movieNameInputSubmitted = () => {
 		// For testing purposes - to indicate being able to hit this section of code
    console.log("hello here we are in moviename input submitted")
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput style={styles.movieNameInput}
                   ...
                   // Listening for change in what is typed into field and setting text to that
                   onChangeText={this.movieNameInputChanged}
      						 // When pressing enter button, do {this.MovieNameInputSubmitted}
